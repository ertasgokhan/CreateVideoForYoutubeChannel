...
namespace CreateVideoForYoutubeChannel.Controllers
{
    public class RobotVacuumController : Controller
    {
        ...
        public IActionResult RobotVacuumVS(RobotVacuumModel robotVacuumModel)
        {
            ...
            const string srcFileName = @"C:\Yutup\ROBOTVACUUM\VS\VS_PPT_ROBOTVACUUM.pptx";
            ...
            for (int i = 0; i < nbSlides; i++)
            {
                ...
                slide.ReplacePicture("product1", @"C:\Yutup\ROBOTVACUUM\VS\product1.png", "image/png");
                slide.ReplacePicture("product2", @"C:\Yutup\ROBOTVACUUM\VS\product2.png", "image/png");
